		...
		my @month_loop = (1..12);
			foreach my $month (@month_loop) {
				...
				if ($pre_content =~ m/naverLoginURL/is) {
					...
					my $username = "jessica8284";
					my $password = "memory602";
